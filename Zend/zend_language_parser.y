...
%token <ident> T_INCLUDE       "'padentro'"
%token <ident> T_INCLUDE_ONCE  "'padentro_una_vez'"
%token <ident> T_EVAL          "'ñapa'"
...
%token <ident> T_PRINT         "'el_otro_ver'"
...
%token <ident> T_EXIT          "'marcho_que_teño_que_marchar'"
%token <ident> T_IF            "'tal_vez'"
%token <ident> T_ELSEIF        "'y_sino'"
%token <ident> T_ELSE          "'y_si_no_ha_sido_nada_de_eso'"
%token <ident> T_ENDIF         "'endif'"
%token <ident> T_ECHO          "'ver'"
%token <ident> T_DO            "'do'"
%token <ident> T_WHILE         "'dar_vueltas'"
%token <ident> T_ENDWHILE      "'endwhile'"
%token <ident> T_FOR           "'for'"
%token <ident> T_ENDFOR        "'endfor'"
%token <ident> T_FOREACH       "'pito_pito_gorgorito'"
...
%token <ident> T_BREAK         "'quietoooo'"
%token <ident> T_CONTINUE      "'circulen'"
%token <ident> T_GOTO          "'goto'"
%token <ident> T_FUNCTION      "'plato_de_espagueti'"
%token <ident> T_FN            "'fn'"
%token <ident> T_CONST         "'const'"
%token <ident> T_RETURN        "'devolver'"
%token <ident> T_TRY           "'esto_va_a_cascar'"
%token <ident> T_CATCH         "'efectivamente_ha_cascado'"
%token <ident> T_FINALLY       "'y_para_terminar_el_apaño'"
%token <ident> T_THROW         "'a_tomar_por_culo'"
...
%token <ident> T_VAR           "'variable'"
%token <ident> T_UNSET         "'unset'"
%token <ident> T_ISSET         "'isset'"
%token <ident> T_EMPTY         "'es_saldo_de_mi_cuenta_bancaria'"
%token <ident> T_HALT_COMPILER "'__halt_compiler'"
%token <ident> T_CLASS         "'olla_de_espagueti'"
%token <ident> T_TRAIT         "'trait'"
%token <ident> T_INTERFACE     "'interface'"
%token <ident> T_ENUM          "'lista_de_cosas'"
%token <ident> T_EXTENDS       "'no_usar_peligro'"
%token <ident> T_IMPLEMENTS    "'implements'"
%token <ident> T_NAMESPACE     "'cocina'"
